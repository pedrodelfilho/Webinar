...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  ============================-->
    ...
    <div class="intro-container wow fadeIn">
      ...
      <a runat="server" id="lblLink" href="#" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
    ...
    <section id="venue" class="wow fadeInUp">
        <div class="container-fluid">
            ...
            <div class="container-fluid venue-gallery-container">
                <div runat="server" id="divEventos1" class="row no-gutters justify-content-md-center">        
                </div>
            </div>
    ...
    <section id="gallery" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          <h2>Acervo</h2>
          <p><a runat="server" id="GaleriaAcervo" href="GaleriaAcervo.aspx">Acessar galeria</a></p>
        </div>
      </div>
      <div runat="server" class="owl-carousel gallery-carousel" id="CarouselAcervo">
      </div>
    </section>
