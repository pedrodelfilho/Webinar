            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <label style="color: white; margin-top: 25px" class="labels">Estilo de apresentação na página inicial</label>
                        <div id="speakers" style="width: 400px; height:0px;">
                            <div class="speaker">                            
                                <img runat="server" id="imgPalestrante1" src="#" alt="Speaker" class="img-fluid" >
                                <div class="details">
                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                ...
                                <asp:Label ID="lblDt" runat="server" ForeColor="Red" Text="&nbsp;Data inválida" Font-Size="16px" Visible="false"></asp:Label>
                            </div>
                            <div class="col-md-6">
