...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background: rgba(6, 12, 34, 0.8); align-content: center"><br /><br /><br /><br /><br /><br /><br />
        ...
        <asp:Panel runat="server" HorizontalAlign="Center">
            ...
            <asp:LinkButton ID="btnSalvarPalestra" OnClick="btnSalvarPalestra_Click" runat="server" Width="180" CssClass="botao btn-success"><i class="fa fa-thumbs-o-up"></i>&nbsp;Ok, Aprovar</asp:LinkButton>   &nbsp;&nbsp;&nbsp; 
