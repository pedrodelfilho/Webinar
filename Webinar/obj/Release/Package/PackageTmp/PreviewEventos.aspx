<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="PreviewEventos.aspx.cs" Inherits="Webinar.PreviewEventos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background: rgba(25, 31, 32, 0.8);" id="intro-container"><br /><br /><br />
        ...
        <asp:Panel ID="PanelEvento" runat="server">
            ...
            <div class="text-center">
                <input action="action" type="button" class="botaosub btn-danger" value="Voltar" onclick="window.history.go(-1); return false;" />  
                <asp:Button runat="server" ID="btnSalvar" OnClick="btnSalvar_Click" CssClass="botaosub btn-success" style="border: 2px solid green" Text="Salvar" /><br /><br /><br /><br />           
            </div>
        </asp:Panel>
    </div>
</asp:Content>
