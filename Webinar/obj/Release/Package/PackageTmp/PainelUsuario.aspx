            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                        <asp:Image runat="server" ID="imgUsuario" CssClass="rounded-circle mt-5" width="250" />  
                ...
                <div class="col-md-7">
                    <div class="p-3 py-5">
                        ...
                        <div class="mt-5 text-center">
                            <asp:LinkButton ID="btnSalvarPerfil" OnClick="btnSalvarPerfil_Click" runat="server" CssClass="botao"><i class="fa fa-save"></i>&nbsp;Salvar</asp:LinkButton>                
                        </div>
